...
/**
 * Created by William Winters on 4/10/2017.
 */
...
public class BarcodeView extends View {
    ...
    public BarcodeView(Context context, String data) {
        super(context);
        datacode = data;
        qrCanvas = new Canvas();
    }
    ...
    private void testQRCode(Canvas qrCanvas) throws Exception
    {
	    ...
	    */
        ...
        barcode.drawBarcode(qrCanvas, bounds);
    }
}
